...
public class Adapter_Contact extends ArrayAdapter {
    Context context;
    int resource;
    ArrayList<ThongTinDanhBa> arrayList;
    ThongTinDanhBa danhBa;
    public Adapter_Contact(@NonNull Context context, int resource, @NonNull ArrayList<ThongTinDanhBa> arrayList) {

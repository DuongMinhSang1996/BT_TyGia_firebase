...
public class DanhBa2Activity extends AppCompatActivity {
    ListView lv_contact;
    ArrayList<ThongTinDanhBa2> arrayList;
    Adapter_Contact2 adapterContact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_danh_ba2);
        addControls();
        addEvents();
    }
    private void addEvents() {
        btn_addContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog=new Dialog(DanhBa2Activity.this);
                ...
                btn_addToFirebase.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        danhBa_temp=new ThongTinDanhBa2(pushId,name_img,name,number,nickname);
        ...
        reference_Contact.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ThongTinDanhBa2 danhBa=dataSnapshot.getValue(ThongTinDanhBa2.class);
    ...
    public void uploadIMG(){
        ...
        filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                adapterContact.notifyDataSetChanged();
                Toast.makeText(DanhBa2Activity.this,"Thêm Thành Công !!!" , Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DanhBa2Activity.this,"Thêm Thất Bại !!!" , Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode==PICK_IMAGE && resultCode==RESULT_OK){
            try {
                uri=data.getData();
                //name_img=uri.getLastPathSegment();
                inputStream_img = DanhBa2Activity.this.getContentResolver().openInputStream(data.getData());
    ...
    private void addControls() {
        ...
        adapterContact=new Adapter_Contact2(DanhBa2Activity.this,R.layout.layout_row_contact,arrayList);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.delete_id:{
                ...
                adapterContact.notifyDataSetChanged();
                ThongTinDanhBa2 thongTinDanhBa2=arrayList.get(info.position);
                arrayList.remove(info.position);
                //Toast.makeText(this, thongTinDanhBa2.getKey(), Toast.LENGTH_SHORT).show();
                reference_Contact.child(thongTinDanhBa2.getKey()).removeValue();
